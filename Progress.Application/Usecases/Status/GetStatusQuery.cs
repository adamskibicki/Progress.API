...
namespace Progress.Application.Usecases.Status
{
    ...
    public class GetStatusQueryHandler : IRequestHandler<GetStatusQuery, StatusDto>
    {
            ...
            var cosmicImmortalSkills = new SkillDto[]
                        {
                            new SkillDto()
                            {
                                ...
                                TierDescriptions = StringArrayToTierDescriptions(new string[]
                                {
        ...
        private TierDescriptionDto[] StringArrayToTierDescriptions(string[] strings)
        {
            return strings.Select((s, i) => new TierDescriptionDto
            {
                Id = Guid.NewGuid(),
                Description = s,
                Tier = i
