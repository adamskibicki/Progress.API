...
namespace Progress.Application.Migrations
{
    ...
    [Migration("20230404122742_AddSkillsTierDescriptionsSkillVariables")]
    partial class AddSkillsTierDescriptionsSkillVariables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Progress.Application.Persistence.Entities.CharacterStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 4, 4, 12, 27, 42, 453, DateTimeKind.Unspecified).AddTicks(4056), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Progress.Application.Persistence.Entities.Skill", b =>
                {
                    b.HasOne("Progress.Application.Persistence.Entities.CharacterClass", null)
                        .WithMany("Skills")
